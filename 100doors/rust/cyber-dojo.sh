...
# ------------------------------------------------------------------------
PATH=/usr/local/cargo/bin:/usr/local/sbin:/usr/local/bin:/usr/bin:/usr/lib/jvm/default/bin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl:/home/ethan/.local/bin:/home/ethan/.local/bin/statusbar:/home/ethan/.local/bin/cron:/home/ethan/.local/share/cargo/bin:/home/ethan/.local/share/cargo/bin
#RUST_BACKTRACE=1
